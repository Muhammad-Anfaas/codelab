...
import { studentClasses, studentAssignments, studentGrades, studentActivity } from '../../mock/data';
...
export default function StudentDashboard() {
  ...
  // Later: GET /api/classes, /api/assignments, /api/grades for the logged-in student.
