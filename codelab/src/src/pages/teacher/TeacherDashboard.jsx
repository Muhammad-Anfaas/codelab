...
import { teacherClasses, teacherAssignments } from '../../mock/data';
...
export default function TeacherDashboard() {
  ...
  // Later: these come from GET /api/classes and GET /api/assignments.
  ...
  return (
    <>
      <div className="page-header">
        ...
        <button type="button" className="btn btn-primary" onClick={() => navigate('/teacher/classes')}>
          ...
          <div className="card-grid">
            {classes.map((cls) => (
              <ClassCard
                ...
                name={cls.name}
                section={cls.section}
                meta={`${cls.studentCount} students`}
